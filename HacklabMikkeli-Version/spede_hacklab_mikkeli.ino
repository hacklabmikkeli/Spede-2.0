...
if (step_finalScores == true) {
  if (showText == 2) {
   ...
   if ( (millis()- currentTimeFinalScores) >= onDurationFinalScores )  {   
      showText = 3;
      currentTimeFinalScores = millis();
   P.displayZoneText(0, "Hacklab", PA_CENTER, 0, 0, PA_PRINT, PA_NO_EFFECT);
   P.displayZoneText(1, "Hacklab", PA_CENTER, 0, 0, PA_PRINT, PA_NO_EFFECT);
   P.displayAnimate(); 
   ...
   if ( (millis()- currentTimeFinalScores) >= onDurationFinalScores )  {   
      showText = 0;
      currentTimeFinalScores = millis();
   P.displayZoneText(0, "Mikkeli", PA_CENTER, 0, 0, PA_PRINT, PA_NO_EFFECT);
   P.displayZoneText(1, "Mikkeli", PA_CENTER, 0, 0, PA_PRINT, PA_NO_EFFECT);
   P.displayAnimate(); 
   }
  }
}
